...
// Circular Gaussian smoothing of a 12-element pitch-class vector.
...
// Duration-weighted pitch-class distribution including harmonic partials.
...
// Spectral centroid of a 12-element distribution, using reference pitch frequencies.
...
// =============================================================================
// Key estimation from pitch-class and interval profiles
// =============================================================================
...
// =============================================================================
// Genre detection heuristics (tempo, density, rhythm, spectral centroid)
// =============================================================================
...
int TransposeEngine::findBestTranspose(const std::vector<int>& notes,
    ...
    // Ties go to 0, so a file with no better fit is left untransposed.
    int bestTranspose = 0;
    double bestScore = evaluateTranspose(notes, 0, genre).total;
